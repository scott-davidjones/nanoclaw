...
|-------|------|-----------|--------|
| Cypher ⚒️ | `developer.md` | Laravel, Vue 3, InertiaJS, test seeders | github-api, bash, file R/W |
| Vector 🧪 | `tester.md` | Pest, PHPUnit, Vitest | bash, github-api (read) |
| Prism 👁️ | `ui-tester.md` | Responsive UI, visual checks, browser testing | agent-browser, bash |
| Sentinel 🛡️ | `reviewer.md` | Code quality, security, standards | github-api, read |
